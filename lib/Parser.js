 ...
 * @type {RegExp}
 */
var fiqlRegExp = /(\([\+\*\$\-:\w%\._,]+\)|[\+\*\$\-:\w%\._]*|)([<>!]?=(?:[\w]*=)?|>|<)(\([\+\*\$\-:\w%\._,]+\)|[\+\*\$\-:\w%\._]*|)/g;
  ...
  for (var i = 0, l = input.length; i < l; ++i)
  {
    ...
    switch (chr)
    {
      ...
      case '|':
      {
        ...
        {
          throw new Error("Can not mix conjunctions within a group at position " + i + ", use parenthesises around each set of the same conjunctions (& and |)");
        }
